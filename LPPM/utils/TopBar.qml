...
Item {
    ...
    property bool wasClosedManually: false
    ...
    Rectangle
    {
        ...
        Rectangle
        {
            ...
            MouseArea
            {
                ...
                onPressed:
                {
                    // let's find out if we should maxime the  root.window or not
        ...
        Rectangle
        {
            ...
            MouseArea
            {
                ...
                onClicked:
                {
                    if (root.wasClosedManually == true)
                    {
                        showSettings = true
                    }
                    ...
                    console.debug(root.clicked, root.settingsWindow.z)
                }
            }
